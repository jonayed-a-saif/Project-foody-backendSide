                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary mt-3">
                            <div class="card-header">
                                <h3 class="card-title">Add New Loader</h3>
                            </div>
                            <form role="form">
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" @click.prevent="addLoader()">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        addLoader () {
            this.form.post('/add/new/loader')
            .then(({ response }) => {
                this.$router.push('/loader-list');

                toast.fire({
                    icon: 'success',
                    title: 'Loader Added successfully'
                })
