                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary mt-3">
                            <div class="card-header">
                                <h3 class="card-title">Add New Shipping Method</h3>
                            </div>
                            <form role="form">
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" @click.prevent="addShippingMethod()">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        addShippingMethod () {
            this.form.post('/add/new/shipping/method')
            .then(({ response }) => {
                this.$router.push('/shippingMethod-list');

                toast.fire({
                    icon: 'success',
                    title: 'Shiiping Method Added successfully'
                })
