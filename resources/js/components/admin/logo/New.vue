                            ...
                            <form role="form">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img :src="form.icon" class="img-fluid mt-1">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img :src="form.logo" class="img-fluid mt-1">
                                    </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" @click.prevent="addLogo()">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
