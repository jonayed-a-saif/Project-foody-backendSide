                        ...
                        <div class="card card-primary mt-3">
                            ...
                            <form role="form">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="ChildCategoryID">Edit Child-Category Name</label>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" @click.prevent="updateChildCategory()">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
export default {
    ...
    created(){
        axios.get(`/edit/childcategory/details/${this.$route.params.childCategoryId}`)
            .then((response)=>{
                this.form.fill(response.data.childcategory)
    ...
    methods:{
        ...
        updateChildCategory(){
            this.form.post('/update/childcategory/'+this.$route.params.childCategoryId)
                .then(()=>{
